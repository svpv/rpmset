...
static inline void pack5x19c16e1(const uint32_t *v, char *s, unsigned e)
{
    uint64_t x;
    x = (e & 1) | (v[0] & Mask(5)) << 1
      | (v[1] & Mask(5)) <<  6 | (v[2] & Mask(5)) << 11 | (v[3] & Mask(5)) << 16
      | (v[4] & Mask(5)) << 21 | (v[5] & Mask(5)) << 26 | (v[6] & Wask(5)) << 31;
    s[ 0] = base64[(x      ) & Mask(6)];
    s[ 1] = base64[(x >>  6) & Mask(6)];
    s[ 2] = base64[(x >> 12) & Mask(6)];
    s[ 3] = base64[(x >> 18) & Mask(6)];
    s[ 4] = base64[(x >> 24) & Mask(6)];
    s[ 5] = base64[(x >> 30)          ];
    uint32_t y;
    y = (v[ 7] & Mask(5))       | (v[ 8] & Mask(5)) <<  5 | (v[ 9] & Mask(5)) << 10
      | (v[10] & Mask(5)) << 15 | (v[11] & Mask(5)) << 20 | (v[12] & Mask(5)) << 25;
    s[ 6] = base64[(y      ) & Mask(6)];
    s[ 7] = base64[(y >>  6) & Mask(6)];
    s[ 8] = base64[(y >> 12) & Mask(6)];
    s[ 9] = base64[(y >> 18) & Mask(6)];
    s[10] = base64[(y >> 24)          ];
    y = (v[13] & Mask(5))       | (v[14] & Mask(5)) <<  5 | (v[15] & Mask(5)) << 10
      | (v[16] & Mask(5)) << 15 | (v[17] & Mask(5)) << 20 | (v[18] & Mask(5)) << 25;
    s[11] = base64[(y      ) & Mask(6)];
    s[12] = base64[(y >>  6) & Mask(6)];
    s[13] = base64[(y >> 12) & Mask(6)];
    s[14] = base64[(y >> 18) & Mask(6)];
    s[15] = base64[(y >> 24)          ];
}

static inline void pack6x16c16(const uint32_t *v, char *s, unsigned e)
{
    s[ 0] = base64[v[ 0] & Mask(6)];
    s[ 4] = base64[v[ 1] & Mask(6)];
    s[ 8] = base64[v[ 2] & Mask(6)];
    s[12] = base64[v[ 3] & Mask(6)];
    s[ 1] = base64[v[ 4] & Mask(6)];
    s[ 5] = base64[v[ 5] & Mask(6)];
    s[ 9] = base64[v[ 6] & Mask(6)];
    s[13] = base64[v[ 7] & Mask(6)];
    s[ 2] = base64[v[ 8] & Mask(6)];
    s[ 6] = base64[v[ 9] & Mask(6)];
    s[10] = base64[v[10] & Mask(6)];
    s[14] = base64[v[11] & Mask(6)];
    s[ 3] = base64[v[12] & Mask(6)];
    s[ 7] = base64[v[13] & Mask(6)];
    s[11] = base64[v[14] & Mask(6)];
    s[15] = base64[v[15] & Mask(6)];
    (void) e;
}

static inline void pack7x12c14(const uint32_t *v, char *s, unsigned e)
{
    uint64_t x;
    x = (v[ 0] & Mask(7))       | (v[ 4] & Mask(7)) <<  7 | (v[ 8] & Mask(7)) << 14
      | (v[ 1] & Mask(7)) << 21 | (v[ 5] & Wask(7)) << 28 | (v[ 9] & Wask(7)) << 35;
    s[ 0] = base64[(x      ) & Mask(6)];
    s[ 1] = base64[(x >>  6) & Mask(6)];
    s[ 2] = base64[(x >> 12) & Mask(6)];
    s[ 3] = base64[(x >> 18) & Mask(6)];
    s[ 4] = base64[(x >> 24) & Mask(6)];
    s[ 5] = base64[(x >> 30) & Mask(6)];
    s[ 6] = base64[(x >> 36)          ];
    x = (v[ 2] & Mask(7))       | (v[ 6] & Mask(7)) <<  7 | (v[10] & Mask(7)) << 14
      | (v[ 3] & Mask(7)) << 21 | (v[ 7] & Wask(7)) << 28 | (v[11] & Wask(7)) << 35;
    s[ 7] = base64[(x      ) & Mask(6)];
    s[ 8] = base64[(x >>  6) & Mask(6)];
    s[ 9] = base64[(x >> 12) & Mask(6)];
    s[10] = base64[(x >> 18) & Mask(6)];
    s[11] = base64[(x >> 24) & Mask(6)];
    s[12] = base64[(x >> 30) & Mask(6)];
    s[13] = base64[(x >> 36)          ];
    (void) e;
}
...
static inline void pack11x8c16e8(const uint32_t *v, char *s, unsigned e)
{
    uint32_t x;
    x = (  e  & Mask(8))
      | (v[0] & Mask(11)) << 8
    ...
    s[14] = base64[(v[6] & Mask(11)) >> 10 |
		   (v[7] & Mask( 5)) <<  1];
    s[15] = base64[(v[7] & Mask(11)) >>  5];
}

static inline void pack11x9c18e9(const uint32_t *v, char *s, unsigned e)
{
    uint64_t y;
    y = (  e  & Mask(9))
      | (v[0] & Mask(11)) << 9
	...
	(v[2] & Mask(11)) << 31;
    s[ 0] = base64[(y & Mask(6))];
    s[ 1] = base64[(y & Mask(12)) >>  6];
    s[ 2] = base64[(y & Mask(18)) >> 12];
    s[ 3] = base64[(y & Mask(24)) >> 18];
    s[ 4] = base64[(y & Mask(30)) >> 24];
    s[ 5] = base64[(y & Wask(36)) >> 30];
    s[ 6] = base64[(y >> 36)];
    s[ 7] = base64[(v[3] & Mask( 6))];
    s[ 8] = base64[(v[3] & Mask(11)) >>  6 |
		   (v[4] & Mask( 1)) <<  5];
    s[ 9] = base64[(v[4] & Mask( 7)) >>  1];
    s[10] = base64[(v[4] & Mask(11)) >>  7 |
		   (v[5] & Mask( 2)) <<  4];
    s[11] = base64[(v[5] & Mask( 8)) >>  2];
    s[12] = base64[(v[5] & Mask(11)) >>  8 |
		   (v[6] & Mask( 3)) <<  3];
    s[13] = base64[(v[6] & Mask( 9)) >>  3];
    s[14] = base64[(v[6] & Mask(11)) >>  9 |
		   (v[7] & Mask( 4)) <<  2];
    s[15] = base64[(v[7] & Mask(10)) >>  4];
    s[16] = base64[(v[7] & Mask(11)) >> 10 |
		   (v[8] & Mask( 5)) <<  1];
    s[17] = base64[(v[8] & Mask(11)) >>  5];
}

static inline void pack11x10c20e10(const uint32_t *v, char *s, unsigned e)
{
    uint64_t y;
    y = (  e  & Mask(10))
      | (v[0] & Mask(11)) << 10
    ...
    s[ 4] = base64[(y & Mask(30)) >> 24];
    s[ 5] = base64[(y & Wask(36)) >> 30];
    s[ 6] = base64[(y & Wask(42)) >> 36];
    s[ 7] = base64[(y & Wask(48)) >> 42];
    s[ 8] = base64[(y & Wask(54)) >> 48];
    s[ 9] = base64[(v[4] & Mask( 6))];
    s[10] = base64[(v[4] & Mask(11)) >>  6 |
		   (v[5] & Mask( 1)) <<  5];
    s[11] = base64[(v[5] & Mask( 7)) >>  1];
    s[12] = base64[(v[5] & Mask(11)) >>  7 |
		   (v[6] & Mask( 2)) <<  4];
    s[13] = base64[(v[6] & Mask( 8)) >>  2];
    s[14] = base64[(v[6] & Mask(11)) >>  8 |
		   (v[7] & Mask( 3)) <<  3];
    s[15] = base64[(v[7] & Mask( 9)) >>  3];
    s[16] = base64[(v[7] & Mask(11)) >>  9 |
		   (v[8] & Mask( 4)) <<  2];
    s[17] = base64[(v[8] & Mask(10)) >>  4];
    s[18] = base64[(v[8] & Mask(11)) >> 10 |
		   (v[9] & Mask( 5)) <<  1];
    s[19] = base64[(v[9] & Mask(11)) >>  5];
}
...
static inline void pack20x6c20(const uint32_t *v, char *s, unsigned e)
{
    uint64_t x;
    x = (v[0] & Mask(20)) | (v[1] & Wask(20)) << 20 | (v[2] & Wask(20)) << 40;
    s[ 0] = base64[x & Mask(6)], x >>= 6;
    s[ 1] = base64[x & Mask(6)], x >>= 6;
    s[ 2] = base64[x & Mask(6)], x >>= 6;
    s[ 3] = base64[x & Mask(6)], x >>= 6;
    s[ 4] = base64[x & Mask(6)], x >>= 6;
    s[ 5] = base64[x & Mask(6)], x >>= 6;
    s[ 6] = base64[x & Mask(6)], x >>= 6;
    s[ 7] = base64[x & Mask(6)], x >>= 6;
    s[ 8] = base64[x & Mask(6)], x >>= 6;
    s[ 9] = base64[x];
    x = (v[3] & Mask(20)) | (v[4] & Wask(20)) << 20 | (v[5] & Wask(20)) << 40;
    s[10] = base64[x & Mask(6)], x >>= 6;
    s[11] = base64[x & Mask(6)], x >>= 6;
    s[12] = base64[x & Mask(6)], x >>= 6;
    s[13] = base64[x & Mask(6)], x >>= 6;
    s[14] = base64[x & Mask(6)], x >>= 6;
    s[15] = base64[x & Mask(6)], x >>= 6;
    s[16] = base64[x & Mask(6)], x >>= 6;
    s[17] = base64[x & Mask(6)], x >>= 6;
    s[18] = base64[x & Mask(6)], x >>= 6;
    s[19] = base64[x];
    (void) e;
}
