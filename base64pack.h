...
static inline void pack10x10c18e8(const uint32_t *v, char *s, unsigned e)
{
    uint32_t x;
    x = (v[0] & Mask(10)) | (v[1] & Mask(10)) << 10 | (v[2] & Mask(10)) << 20;
    s[ 0] = base64[(x & Mask( 6))];
...
static inline void pack12x8c16(const uint32_t *v, char *s, unsigned e)
{
    ...
    s[ 2] = base64[(v[1] & Mask( 6))];
    s[ 3] = base64[(v[1] & Mask(12)) >> 6];
    s[ 4] = base64[(v[2] & Mask( 6))];
    s[ 5] = base64[(v[2] & Mask(12)) >> 6];
    s[ 6] = base64[(v[3] & Mask( 6))];
    s[ 7] = base64[(v[3] & Mask(12)) >> 6];
    s[ 8] = base64[(v[4] & Mask( 6))];
    s[ 9] = base64[(v[4] & Mask(12)) >> 6];
    s[10] = base64[(v[5] & Mask( 6))];
    s[11] = base64[(v[5] & Mask(12)) >> 6];
    s[12] = base64[(v[6] & Mask( 6))];
    s[13] = base64[(v[6] & Mask(12)) >> 6];
